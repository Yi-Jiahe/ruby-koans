...
class AboutMethods < Neo::Koan
  ...
  def test_sometimes_missing_parentheses_are_ambiguous
    ...
    # The error output for this is useless
  end
  ...
  def test_calling_methods_in_same_class
    ...
    # I didn't notice but all the tests so far have been methods of the same class
  end
  ...
  if before_ruby_version("2.7")   # https://github.com/edgecase/ruby_koans/issues/12
    # Wow that's a strange issue. I guess the default is not to use an explict self receiver
  ...
  def test_calling_private_methods_in_other_objects
    ...
    assert_raise(NoMethodError) do
      # The error for NoMethodError mentions that it's a private method.
      rover.tail
    end
  end
end
